...
var e = (document.getElementById("trial")) as HTMLSelectElement;
//select must be defined as a HTMLelement.
  ...
  render() {
    return (
      <div>
        <header>
          <h1>2019</h1>
          <select id="trial" onChange={this.handleChange} value={this.month || this.months[this.now.getMonth()]}>
